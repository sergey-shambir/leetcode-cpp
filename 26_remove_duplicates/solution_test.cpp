...
{
    REQUIRE_THAT(removeDuplicates({ 1, 1, 2 }), Equals<int>({ 1, 2 }));
}
...
{
    REQUIRE_THAT(removeDuplicates({ 0, 0, 1, 1, 1, 2, 2, 3, 3, 4 }), Equals<int>({ 0, 1, 2, 3, 4 }));
}
...
TEST_CASE("Own tests")
{
    ...
    REQUIRE_THAT(removeDuplicates({ 1, 2, 2, 5, 7, 7, 7, 11, 11, 11, 11 }), Equals<int>({ 1, 2, 5, 7, 11 }));
}
